...
import com.example.weatherapp.databinding.ActivityMainDdBinding

class MainActivity_dd : AppCompatActivity() {
    private lateinit var binding: ActivityMainDdBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityMainDdBinding.inflate(layoutInflater)
